...
Namespace SpreadsheetControl_WPF_API_Part03
	Public MustInherit Class ExampleCodeEvaluator
		...
		Protected Friend Function CompileAndRun(ByVal linesOfCode() As String, ByVal evaluationParameter As Object) As Boolean
			...
			Dim referencesDX() As String = {AssemblyInfo.SRAssemblyData, GetModuleAssembly(), AssemblyInfo.SRAssemblyOfficeCore, AssemblyInfo.SRAssemblyPrintingCore, AssemblyInfo.SRAssemblyPrinting, AssemblyInfo.SRAssemblyUtils}
...
'INSTANT VB NOTE: The variable codeStart was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private Const codeStart_Renamed As String = "using System;" & ControlChars.CrLf & "using DevExpress.Spreadsheet;" & ControlChars.CrLf & "using System.Drawing;" & ControlChars.CrLf & "using System.Windows.Forms;" & ControlChars.CrLf & "using DevExpress.Utils;" & ControlChars.CrLf & "using System.IO;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Diagnostics;" & ControlChars.CrLf & "using System.Xml;" & ControlChars.CrLf & "using System.Data;" & ControlChars.CrLf & "using System.Collections.Generic;" & ControlChars.CrLf & "using System.Linq;" & ControlChars.CrLf & "using System.Globalization;" & ControlChars.CrLf & "namespace RichEditCodeResultViewer { " & ControlChars.CrLf & "public class ExampleItem { " & ControlChars.CrLf & "        public static void Process(IWorkbook workbook) { " & ControlChars.CrLf & ControlChars.CrLf
...
'INSTANT VB NOTE: The variable codeEnd was renamed since Visual Basic does not allow variables and other class members to have the same name:
	...
	Public Class RichEditVbExampleCodeEvaluator
		...
		End Function
'INSTANT VB NOTE: The variable codeStart was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private Const codeStart_Renamed As String = "Imports Microsoft.VisualBasic" & ControlChars.CrLf & "Imports System" & ControlChars.CrLf & "Imports DevExpress.Spreadsheet" & ControlChars.CrLf & "Imports System.Drawing" & ControlChars.CrLf & "Imports System.Windows.Forms" & ControlChars.CrLf & "Imports DevExpress.Utils" & ControlChars.CrLf & "Imports System.IO" & ControlChars.CrLf & "Imports System.Linq" & ControlChars.CrLf & "Imports System.Diagnostics" & ControlChars.CrLf & "Imports System.Xml" & ControlChars.CrLf & "Imports System.Data" & ControlChars.CrLf & "Imports System.Collections.Generic" & ControlChars.CrLf & "Imports System.Globalization" & ControlChars.CrLf & "Namespace RichEditCodeResultViewer" & ControlChars.CrLf & "	Public Class ExampleItem" & ControlChars.CrLf & "		Public Shared Sub Process(ByVal workbook As IWorkbook)" & ControlChars.CrLf & ControlChars.CrLf
